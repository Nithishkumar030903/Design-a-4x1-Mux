...
HD_PWD='C:/Users/nithi/mux_4x1_top/mux_4x1_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_4x1_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_4x1_top.tcl
