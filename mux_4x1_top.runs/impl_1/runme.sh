...
HD_PWD='C:/Users/nithi/mux_4x1_top/mux_4x1_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_4x1_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_4x1_top.tcl -notrace
